...
function animLoop() {	//This function is the one that triggers every function triggering every other, but perfomance is still kept via the scroll variable.
...
animLoop(); //Initiates the functions calling each other